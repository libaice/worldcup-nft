...
import worldcup from './assets/wordcup.svg'
...
function App() {
  ...
  useEffect(() => {
    document.title = 'FIFA 2022 World Cup NFT'
  }, [i18n])
  ...
  return (
    ...
    >
      <div className='text-[#EEE] w-full pc_header'>
        {!isMobile() && <img src='/worldcup/worldcup-bg.png' className='hero-bg' />}
            ...
            >
              <div className='box-container flex-between h-16'>
                <div className='brand flex gap-4'>
                  <img className='h-[40px]' src={worldcup} alt='' />
