import wamo from './assets/wordcup.svg'
    ...
    <div className="bg-black">
      {isMobile() ? (
        ...
        <div className="box-container flex-between pt-12 pb-8 border-b border-white text-white mt-[2rem]">
          <div className="flex gap-4">
            {/*<img src={wamo} alt="Qutar world Cup" />*/}
            <div className="flex flex-col gap-2">
              <div>Qutar world Cup</div>
              <div className="text-sm">Web3 powered World Cup </div>
            </div>
          </div>
          <div>
            ...
            <div className="social mt-3 flex ">
              <img
                src="/telegram.png"
                alt="dali_web3"
                onClick={() => openSocial('https://www.telegram.com/')}
              />
              <img
                src="/twitter.png"
                alt="@dali_web3"
              ...
              <img
                ...
                alt="@dali_web3"
                className="ml-8"
                onClick={() => openSocial('https://github.com/')}
              />
              <img
                src="/discord.png"
                alt="discord png"
